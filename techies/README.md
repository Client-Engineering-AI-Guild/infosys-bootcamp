...
You can find step-by-step instructions in [this document](./Intelligent%20AI%20Assistant advanced.md). It shows how you can implement the use case using watsonx.ai and watsonx Orchestrate. 
